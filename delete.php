...
<head>
    ...
    <title>Delete Participant | Cit-E Admin</title>
...
<body class="bg-base bg-admin-roster bg-static d-flex flex-row" style="min-height: 100vh;">
    ...
    <main class="flex-grow-1 p-4 p-md-5 overflow-auto" style="height: 100vh;">
        <div class="mb-1 fw-bold text-info" style="font-size: 0.85rem;">Admin / Roster / Delete</div>
        
        <div class="d-flex justify-content-between align-items-center mb-5">
            <h2 class="fw-bold text-white mb-0">Delete Participant</h2>
            ...
            try {
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    echo "<div class='alert alert-success d-flex align-items-center' role='alert'>
                            ...
                            <div><strong>Success!</strong> Participant has been successfully deleted.</div>
                          </div>";
                    echo "<a href='view_participants_edit_delete.php' class='btn btn-info fw-bold w-100 rounded-pill mt-3'>Return to Participant List</a>";
                    ...
                    echo "<div class='alert alert-danger d-flex align-items-center mb-4' role='alert'>
                            ...
                            <div>Are you sure you want to delete <strong>" . htmlspecialchars($p['firstname']) . " " . htmlspecialchars($p['surname']) . "</strong>?<br>This action cannot be undone.</div>
                        </div>";
                    
                    echo "<form method='POST' action='delete.php'>";
                    echo "<input type='hidden' name='id' value='" . htmlspecialchars($p['id']) . "'>";
                    echo "<button type='submit' class='btn btn-danger fw-bold w-100 rounded-pill mb-3'>Yes, Delete Participant</button>";
                    echo "<a href='view_participants_edit_delete.php' class='btn btn-outline-secondary text-white fw-bold w-100 rounded-pill'>Cancel</a>";
                    echo "</form>";
                }
